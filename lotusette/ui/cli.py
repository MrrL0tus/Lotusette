...
from lotusette.core.llm import LLMFactory, PromptManager, Message
from lotusette.core.memory import ShortTermMemory, LongTermMemory
    ...
    async def initialize(self):
        ...
        try:
            ...
            if settings.llm_provider == "openai":
                ...
                console.print(f"[red]❌ Erreur: Fournisseur LLM non supporté: {settings.llm_provider}[/red]")
                return False
            ...
            console.print(f"[green]✓ LLM initialisé: {settings.llm_provider} ({self.llm.model})[/green]")

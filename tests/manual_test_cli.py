...
async def test_cli_demo():
    ...
    await cli.short_term_memory.add_message("assistant", "Salut! Comment puis-je t'aider?", cli.session_id)
    ...
    print(f"   Longueur du prompt système: {len(cli.prompt_manager.get_system_prompt())} caractères")
